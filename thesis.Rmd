...
\authornameonly{$student$}

\author{\Authornameonly\\{\bigskip}Supervisor: $supervisor$}
...
<!--chapter:end:perf-Plagiarism.Rmd-->
...
<!--chapter:end:perf-Acknowledgements.Rmd-->

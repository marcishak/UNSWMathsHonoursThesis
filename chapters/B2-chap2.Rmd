...
You can include scripts that are [not directly embedded](https://bookdown.org/yihui/rmarkdown-cookbook/option-code.html) 
into the Rmd format
...
```{r echo=TRUE, code=xfun::read_utf8('scripts/histnorm.R')}
```
or [by using labelled blocks in your script and using them as individual chunks](https://bookdown.org/yihui/rmarkdown-cookbook/read-chunk.html)
